...
void selectionSort(int length , char *MasFile)
{
	...
	printf("Время затраченное на selection сортировку: %0.10lf\n", ptr/CLOCKS_PER_SEC);
}
...
void bubbleSort(int length, char *MasFile)
{
	...
	clock_t end = clock();
	double ptr = end - begin; 
	printf("Время затраченное насортировку bubble: %0.10lf\n", ptr/CLOCKS_PER_SEC);
}
...
void insertionSort(int length, char *MasFile)
{
	...
	clock_t end = clock();
	double ptr = end - begin; 
	printf("Время затраченное на selection сортировку insertion: %0.10lf\n", ptr/CLOCKS_PER_SEC);
}
